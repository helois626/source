        ...
        public void onClick(View v) {
            ...
            switch (getPosition()){
                ...
                case 4:
                    ...
                    break;
                case 5:
                    homeActivity.displayView(5);
                    break;
                case 6:
                    homeActivity.displayView(6);
                    break;
                case 7:
                    homeActivity.displayView(7);
                    break;
            }
//            if(temp != null){
...
//            }
//            temp = v;
//            temp.setBackgroundResource(R.mipmap.list_background);
        }
    }

    public RecyclerViewAdapter(String Titles[], TypedArray Icons, String Name, String Email, int Profile, Context context) { // MyAdapter Constructor with titles and icons parameter
